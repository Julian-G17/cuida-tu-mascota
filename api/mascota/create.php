...
$mascota->id_usuario = $data->id_usuario;
    ...
    // if unable to create the mascota, tell the user
    else{
        ...
        // tell the user
		echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to create mascota","document"=> ""));
    }
}
...
// tell the user data is incomplete
    ...
    // tell the user
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to create mascota. Data is incomplete.","document"=> ""));
}
?>
